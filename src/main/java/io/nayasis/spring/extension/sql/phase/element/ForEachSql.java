...
import io.nayasis.spring.extension.sql.sqlMaker.QueryResolver;
...
public class ForEachSql extends BaseSql {
	...
	private String bindSequenceToIndex( String sql, QueryParameter param, int i ) {
		...
		String newIndex = String.format( "%s[%d]", FOR_EACH_INDEX, param.addForeachIndex(i) );
