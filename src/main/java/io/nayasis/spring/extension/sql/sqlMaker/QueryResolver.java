package io.nayasis.spring.extension.sql.sqlMaker;

import io.nayasis.basica.base.format.Formatter;
import io.nayasis.spring.extension.sql.entity.QueryParameter;
import lombok.experimental.UtilityClass;

import static io.nayasis.basica.base.format.Formatter.PATTERN_DOLLAR;
import static io.nayasis.basica.base.format.Formatter.PATTERN_SHARP;
